...
class DatabaseService:
    ...
    def create_strategy_risk_config(
        ...
        unrealized_profit_alert_usdt: Optional[float] = None,
        unrealized_loss_alert_usdt: Optional[float] = None,
        unrealized_pnl_alert_cooldown_minutes: int = 30,
        enabled: bool = True,
        ...
        config = StrategyRiskConfig(
            ...
            unrealized_profit_alert_usdt=unrealized_profit_alert_usdt,
            unrealized_loss_alert_usdt=unrealized_loss_alert_usdt,
            unrealized_pnl_alert_cooldown_minutes=unrealized_pnl_alert_cooldown_minutes,
            enabled=enabled,
