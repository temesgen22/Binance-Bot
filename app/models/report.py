...
class TradeReport(BaseModel):
    ...
    fee_paid: float = Field(default=0.0, description="Total trading fees paid for this trade (actual from Binance)")
    funding_fee: float = Field(default=0.0, description="Total funding fees paid for this trade")
...
class StrategyReport(BaseModel):
    ...
    total_fee: float = Field(default=0.0, description="Total trading fees paid across all trades")
    total_funding_fee: float = Field(default=0.0, description="Total funding fees paid across all trades")
