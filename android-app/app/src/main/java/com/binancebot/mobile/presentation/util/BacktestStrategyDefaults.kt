...
object BacktestStrategyDefaults {
    ...
    fun getDefaultParams(strategyType: String): Map<String, Any> = when (strategyType) {
        "scalping", "reverse_scalping" -> mapOf(
            ...
            "entry_mode" to "cross_only",
            "trend_entry_max_candles_after_cross" to 0,
            "trend_entry_unlimited_after_cross" to false,
            "trend_entry_max_per_regime" to 1,
            "trend_entry_require_ema_separation" to true,
